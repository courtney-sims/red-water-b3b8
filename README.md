...
```
npm create cloudflare@latest -- --template=cloudflare/templates/red-water-b3b8
```

A live public deployment of this template is available at [https://red-water-b3b8.templates.workers.dev](https://red-water-b3b8.templates.workers.dev)
